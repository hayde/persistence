...
public abstract class GenericEntityFunctions {
    ...
    public <T> T save(StatelessSession session) throws Exception {
        T returnValue = null;
    ...
    public <T> T load(StatelessSession session, long ID) throws Exception {
        T returnValue = null;
        try {
    ...
    public <T> List<T> list(StatelessSession session) throws Exception {
    ...
    public <T> boolean delete(StatelessSession session) throws Exception {
